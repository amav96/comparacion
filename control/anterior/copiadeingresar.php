<?php
	...
	class numeros
	{
		...
		private $tablareferencia1= 'rcompleta';
		...
		function listar($c1){
			...
			$inf.='<tbody>';
				$sql="SELECT n.id_num, n.telefono, r.empresa, r.servicio, r.modalidad, r.localidad,
				 r.indicativo, r.bloque, r.resolucion, r.fecha, r.reemplazar_por, r.caracteres, n.ident,estado
				  FROM ".$this->aprocesar." n LEFT JOIN ".$this->tablareferencia1." r ON n.telefono LIKE n.buscar ORDER BY n.id_num ; ";
