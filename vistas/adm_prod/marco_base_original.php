...
<head>
  ...
  <?php
    $inf = null;
    require_once('../../control/adm_prod/insertar_base_original.php');
    $inf = index($rut);
  ?>
</head>
...
<div class="wrapper">
  ...
  <div class="modal fade" id="importar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <form method="post" enctype="multipart/form-data" action="../../control/adm_prod/insertar_base_original.php">
